...
globalUniforms: [
                ...
                ShaderUniform(name: "maskPixelSpacingH", defaultValue: 3.0, minValue: 1.0, maxValue: 10.0, displayName: "Mask Pixel Spacing H"),
                ShaderUniform(name: "maskPixelSpacingV", defaultValue: 3.0, minValue: 1.0, maxValue: 10.0, displayName: "Mask Pixel Spacing V"),
                ShaderUniform(name: "maskSubpixelGap", defaultValue: 0.3, minValue: 0.0, maxValue: 0.9, displayName: "Subpixel Gap"),
                ShaderUniform(name: "useMask", defaultValue: 0.0, minValue: 0.0, maxValue: 1.0, displayName: "CRT Subpixel Mask", type: .toggle),
            ],
