...
// Do NOT register here - it would cause GameLauncher.launchGame() to detect a "duplicate"
    ...
    private func listCores() {
        ...
        print("\nUsage: open -a TruchiEmu --args --launch /path/to/rom --core <core_id>\n")
    }
    
    @MainActor
    private func listSystems() {
        print("\n=== TruchiEmu Supported Systems ===\n")
        ...
        print("\nUsage: open -a TruchiEmu --args --launch /path/to/rom\n")
    }
    ...
    private func printHelp() {
        ...
        Examples:
          ...
          open -a TruchiEmu --args --launch ~/Roms/Mario.nes
        
          # Launch with specific core
          open -a TruchiEmu --args --launch ~/Roms/Mario.nes --core fceumm
        
          # Launch and load from slot 3
          open -a TruchiEmu --args --launch ~/Roms/Mario.nes --slot 3
        
          # Launch with shader and achievements
          open -a TruchiEmu --args --launch ~/Roms/Mario.nes --shader builtin-crt-classic --achievements

          # Launch with custom shader uniform overrides
          open -a TruchiEmu --args --launch ~/Roms/Mario.nes --shader builtin-crt-classic --shader-uniform "barrelAmount=0.25" --shader-uniform "scanlineIntensity=0.5" --shader-uniform "colorBoost=1.2"
        
          # Launch with hardcore mode and cheats
          open -a TruchiEmu --args --launch ~/Roms/Mario.nes --achievements --hardcore --cheats

          # Launch with custom bezel
          open -a TruchiEmu --args --launch ~/Roms/Mario.nes --bezel "crt-curved.png"

          # Launch with bezel disabled
          open -a TruchiEmu --args --launch ~/Roms/Mario.nes --bezel none
        
          # Launch with core options
          open -a TruchiEmu --args --launch ~/Roms/Mario.nes --core-option "mupen64plus-cpucore=dynamic"
        
          # Headless test (returns 0 if frames render, 1 if not)
          open -a TruchiEmu --args --launch ~/Roms/Mario.nes --headless --timeout 10
        
          # List all cores
          open -a TruchiEmu --args --list-cores
    ...
    private func printVersion() {
        ...
        print("TruchiEmu v\(version) (Build \(build))")
    }
